                ...
                <table class="table align-middle table-dark table-hover table-striped" id="tableCategory">
                    ...
                    <tbody class="">
                        ...
                        @isset($products)
                                ...
                                <tr class="table-dark" id="p{{$products->id}}">
                                    <th scope="row">{{$products->id}}</th>
                                    <td id="u{{$products->id}}">{{$products->name}}</td>
                                    <td id="i{{$products->id}}"> <img src="{{asset('images')}}/{{$products->image}}" style="max-width:100px;" alt="{{$cate->name}}"> </td>
                                    <td id="f{{$products->id}}">{{$products->price}}</td>
                                    <td id="l{{$products->id}}">{{$products->quantity}}</td>
                                    <td id="e{{$products->id}}">{{$products->category->name}}</td>
                                    <td id="S{{$products->id}}">{{$products ->getStatus()}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{Route('admin.prodcut.show',['id' => $products->id])}}" class="btn btn-info" >Edit</a>
